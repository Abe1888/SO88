...
export default function SocialMediaQuestionnaire() {
  ...
  const [selectedPaletteColor, setSelectedPaletteColor] = useState({ hex: "#2CC295", name: "Mountain Meadow" })
  ...
  const handleColorSelect = (hex: string, name: string) => {
    setSelectedPaletteColor({ hex, name })
  }
                ...
                >
                  <div className="p-6">
                    <ExamplePostPreview
                      ...
                      selectedPaletteColor={selectedPaletteColor.hex}
                      selectedPaletteColorName={selectedPaletteColor.name}
                      logoUrl={logoUrl}
                    />
                  </div>
                </motion.div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <TabsContent value="account">
                    ...
                    >
                      <div className="space-y-6">
                        <div>
                          <Label htmlFor="existingAccounts" className="dark:text-gray-300">
                        ...
                        <div>
                          <Label htmlFor="accountDetails" className="dark:text-gray-300">
                            If yes, please provide the account names/handles:
                          </Label>
                          <Textarea
                            id="accountDetails"
                        ...
                        <div>
                          <Label className="dark:text-gray-300">
                            Which platforms do you need new accounts created for?
                          </Label>
                          <div className="flex flex-wrap gap-4 mt-2">
                            {["LinkedIn", "Facebook", "Instagram", "X"].map((platform) => (
                              <div key={platform} className="flex items-center space-x-2">
                                <Checkbox id={`platform-${platform}`} className="form-checkbox" />
                                <Label htmlFor={`platform-${platform}`} className="dark:text-gray-300">
                                  {platform}
                                </Label>
                              </div>
                            ))}
                        ...
                        <div>
                          <Label htmlFor="platformPriority" className="dark:text-gray-300">
                            Which platform is your highest priority for engagement?
                          </Label>
                          <Input id="platformPriority" placeholder="e.g., Facebook" className="form-input" />
                        </div>
                      </div>
                    </QuestionnaireTabContent>
                  </TabsContent>
                    ...
                    >
                      <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                          <div>
                            <Label htmlFor="brandLogo" className="block mb-2 text-sm font-medium dark:text-gray-300">
                              Logo:
                            </Label>
                            <Input
                              type="file"
                            ...
                            <div
                              ...
                              className="mt-2 h-[50px] border border-dashed border-gray-300 dark:border-gray-600 p-1 text-center text-xs text-gray-400 italic flex items-center justify-center"
                            >
                              No logo
                            </div>
                          </div>
                          <div>
                            ...
                            <div className="flex items-center space-x-2">
                              <Input
                                ...
                                className="w-8 h-8 p-0.5 rounded-md form-input"
                              />
                              <Input
                                type="text"
                                value={brandColor}
                                onChange={(e) => setBrandColor(e.target.value)}
                                className="flex-grow text-sm form-input"
                                placeholder="#000000"
                              />
                            </div>
                          </div>
                          ...
                          <div>
                            <Label
                              htmlFor="fontSelection"
                              className="block mb-2 text-sm font-medium dark:text-gray-300"
                            >
                              Font:
                            </Label>
                            <Select value={selectedFont} onValueChange={setSelectedFont} className="form-select">
                      ...
                      <div className="space-y-6">
                        <div>
                          <Label htmlFor="topics" className="dark:text-gray-300">
                            Provide topics for a 3-month plan (4 posts per month):
                          </Label>
                          <Textarea id="topics" placeholder="Example: Month 1: - Post 1: Topic... - Post 2: Topic..." />
                        </div>
                        <div>
                          <Label htmlFor="postingFrequency" className="dark:text-gray-300">
                            Posting Frequency:
                          </Label>
                          <Input id="postingFrequency" placeholder="e.g., 4 posts per month" className="form-input" />
                        </div>
                        <div>
                          <Label htmlFor="postingDays" className="dark:text-gray-300">
                            Preferred Posting Day & Time:
                          </Label>
                          <Input type="datetime-local" id="postingDays" className="form-input" />
                        </div>
                        <div>
                          <Label htmlFor="postingTimes" className="dark:text-gray-300">
                        ...
                        <div>
                          <Label className="dark:text-gray-300">Content Mix (select all that apply):</Label>
                          <div className="flex flex-wrap gap-4 mt-2">
                            {[
                              "Educational Posts",
                              "Case Studies",
                              ...
                              <div key={content} className="flex items-center space-x-2">
                                <Checkbox id={`content-${content}`} className="form-checkbox" />
                                <Label htmlFor={`content-${content}`} className="dark:text-gray-300">
                                  {content}
                                </Label>
                              </div>
                            ))}
                        ...
                        <div>
                          <Label htmlFor="targetAudience" className="dark:text-gray-300">
                            Describe your primary target audience:
                          </Label>
                          <Textarea id="targetAudience" placeholder="Demographics, interests, location" />
                        </div>
                        <div>
                          <Label htmlFor="toneOfVoice" className="dark:text-gray-300">
                            Preferred Tone of Voice:
                          </Label>
                          <Input
                            id="toneOfVoice"
                            placeholder="e.g., Professional and Inspirational"
                            className="form-input"
                          />
                        </div>
                      </div>
                  ...
                  <TabsContent value="engagement">
                    ...
                    >
                      <div className="space-y-6">
                        <div>
                          <Label htmlFor="approvalProcess" className="dark:text-gray-300">
                            Who is the primary contact for content approval?
                          </Label>
                          <Input id="approvalProcess" className="form-input" />
                        </div>
                        <div>
                          <Label htmlFor="approvalTurnaround" className="dark:text-gray-300">
                            Expected turnaround time for content approval:
                          </Label>
                          <Input id="approvalTurnaround" placeholder="e.g., 24-48 hours" className="form-input" />
                        </div>
                      </div>
                    </QuestionnaireTabContent>
                  </TabsContent>
                  <TabsContent value="metrics">
                    ...
                    >
                      <div className="space-y-6">
                        <div>
                          <Label htmlFor="socialMediaGoals" className="dark:text-gray-300">
                        ...
                        <div>
                          <Label htmlFor="KPIs" className="dark:text-gray-300">
                            Which key metrics are most important to you?
                          </Label>
                          <Input
                            id="KPIs"
                            placeholder="e.g., impressions, reach, engagement rate, conversions"
                            className="form-input"
                          />
                        </div>
                        <div>
                          <Label htmlFor="reportingFrequency" className="dark:text-gray-300">
                  ...
                  <TabsContent value="additional">
                    ...
                    >
                      <div className="space-y-6">
                        <div>
                          <Label htmlFor="campaignIntegration" className="dark:text-gray-300">
                        ...
                        <div>
                          <Label htmlFor="internalResources" className="dark:text-gray-300">
                        ...
                        <div>
                          <Label htmlFor="internalResourcesAttachment" className="dark:text-gray-300">
                            Upload Attachment for Internal Resources:
                          </Label>
                          <Input
                            type="file"
                        ...
                        <div>
                          <Label htmlFor="compliance" className="dark:text-gray-300">
